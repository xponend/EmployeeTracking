...
def contact(request):
    if request.method == 'POST':
        ...
        recipient_list = ["employer@gmail.com",
                          "employer1@gmail.com",
                          "employer2@gmail.com",
                          "employer3@gmail.com"]
...
def org_change_password(request):
    if request.method == 'POST':
        ...
        if org_details:
            ...
            message = f'Hi, your password was changed successfully! From EmployeeTrackingDesk'
            email_from = settings.EMAIL_HOST_USER
            recipient_list = [o_email, ]
            send_mail(subject, message, email_from, recipient_list)
...
def report_org(request):
    if request.method == 'POST':
        ...
        recipient_list = ["employer@gmail.com",
                          ...
                          "employer3@gmail.com"]
        send_mail(subject, message, email_from, recipient_list)
        send_mail(subject, "Your Problem has been recorded. From: EmployeeTrackingDesk", email_from, [cemail])
