        ...
        function init( createOffer, partnerName ) {
            ...
            pc[partnerName].ontrack = ( e ) => {
                ...
                if ( document.getElementById( `${ partnerName }-video` ) ) {
                    ...
                    // Around line 203
                    controlDiv.innerHTML = `<i class="fa fa-microphone text-white pr-3 mute-remote-mic" title="Отключить звук"></i>
                    <i class="fa fa-expand text-white expand-remote-video" title="Развернуть"></i>`;
